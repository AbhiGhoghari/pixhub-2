        ...
        <section className="relative w-full pb-20">
            <div className="mx-auto max-w-7xl px-6">
                ...
                <div className="text-center mb-10">
                    <div className="text-sm font-semibold tracking-[.25em] text-indigo-300/70">PRICING</div>
                    ...
                    <div className="mt-6 inline-flex items-center gap-2 rounded-full bg-white/5 p-1 ring-1 ring-white/10">
                        <button className="px-4 py-1.5 rounded-full text-sm font-semibold text-white/80 hover:text-white">
                            Monthly
                        </button>
                        <button className="px-4 py-1.5 rounded-full bg-gradient-to-r from-indigo-600 to-blue-600 text-white text-sm font-semibold shadow-[0_6px_20px_rgba(79,70,229,.35)] ring-1 ring-indigo-400/30">
                            Yearly <span className="ml-1 rounded-md bg-emerald-500/20 px-1.5 py-0.5 text-emerald-300 text-[10px] font-bold">-10%</span>
                        </button>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                    {plans.map((p) => (
                        <div
                            key={p.key}
                            className="relative cut-corner rounded-2xl border-2 border-transparent conic-border animate-border"
                        >
                            <div
                                className={`relative rounded-2xl cut-corner p-7 h-full ring-1 ring-white/5 shadow-[0_16px_40px_rgba(0,0,0,.35)]
          ${p.ribbon ? 'bg-[#0e1530]' : 'bg-[#0c1024]'}
        `}
                            >
                                {/* ribbon (uncomment if you want it) */}
                                {/* {p.ribbon && (
