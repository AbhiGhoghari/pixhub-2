...
export function Footer() {
    return (
        <div className="relative flex h-[400px] w-full flex-col items-center justify-center overflow-hidden rounded-lg bg-gradient-to-b from-[#0b1224] via-[#0a1020] to-[#090e1a]">
            <p className="pb-5 absolute top-24 z-10 whitespace-pre-wrap text-5xl font-extrabold tracking-tight text-gradient-blue drop-shadow-[0_0_24px_rgba(59,130,246,.45)]">
                Pixhub logo
            </p>
            <div className="pt-14">
                <BlueInput
